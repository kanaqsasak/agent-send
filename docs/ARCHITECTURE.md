...
See [THREAT_MODEL.md](THREAT_MODEL.md) and [RELEASE_READINESS.md](RELEASE_READINESS.md) for the precise automated-test claims and the remaining unverified release work.
